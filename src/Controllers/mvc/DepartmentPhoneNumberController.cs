...
{
    public class DepartmentPhoneNumberController : Controller
    {
        private readonly ApplicationDbContext _context;

        public DepartmentPhoneNumberController(ApplicationDbContext context)
        {
            _context = context;
        }

		// GET: DepartmentPhoneNumber
		...
		// GET: DepartmentPhoneNumber/Details/5
		...
		// GET: DepartmentPhoneNumber/Create
		public IActionResult Create()
        {
            return View();
        }

		// POST: DepartmentPhoneNumber/Create
		...
		// GET: DepartmentPhoneNumber/Edit/5
		...
		// POST: DepartmentPhoneNumber/Edit/5
		// To protect from overposting attacks, please enable the specific properties you want to bind to, for 
		// more details see http://go.microsoft.com/fwlink/?LinkId=317598.
		[HttpPost]
        [ValidateAntiForgeryToken]
		...
		// GET: DepartmentPhoneNumber/Delete/5
		...
		// POST: DepartmentPhoneNumber/Delete/5
